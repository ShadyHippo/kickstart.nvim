...
vim.keymap.set('n', '<C-e>', '5<C-e>', { desc = 'Scroll up' })
vim.keymap.set('v', '<C-e>', '5<C-e>', { desc = 'Scroll up' })
vim.keymap.set('n', '<C-y>', '5<C-y>', { desc = 'Scroll down' })
...
-- misc keymaps
vim.keymap.set('n', '<leader><esc>', vim.cmd.Ex, { desc = 'go to file system' })
vim.keymap.set('v', '<A-j>', ":m '>+1<CR>gv=gv", { desc = 'Alt down to shift line down' })
vim.keymap.set('v', '<A-k>', ":m '<-2<CR>gv=gv", { desc = 'Alt up to shift line up' })

vim.keymap.set('n', 'J', 'mzJ`z', { desc = 'Keep the cursor centered for line Join' })
vim.keymap.set('n', '<C-d>', '<C-d>zz', { desc = 'scroll down half screen center cursor' })
vim.keymap.set('n', '<C-u>', '<C-u>zz', { desc = 'scroll up half screen center cursor' })
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- highlight the stuff if I want it
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          --alternative option if I hate ctrl y['<CR>'] = cmp.mapping.confirm { select = true },
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap('v', 'x', ':HopWord<cr>', { silent = true })
      vim.api.nvim_set_keymap('n', 'X', ':HopCamelCase<cr>', { silent = true })
      vim.api.nvim_set_keymap('v', 'X', ':HopCamelCase<cr>', { silent = true })
    end,
  },
  {
